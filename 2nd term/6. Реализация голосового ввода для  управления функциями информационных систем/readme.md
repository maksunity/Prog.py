Лабораторная работа №6: Реализация голосового ввода для
 ...
 2. Ду 
python -m venv ./venvля этого нужно создать виртуальную сред
...
openai/whisper: Robust Speech Recognition via Large-Scale Weak Supervision):
 ...
 токенизировать (изучите NLTK и конкретно nltk.tokenize) и нормализовать (лемматизировать) (через pymorphy3).
